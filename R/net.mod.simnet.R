...
#'
#' @description This function simulates a dynamic network over one or multiple
#'              time steps, to be used in \code{\link{netsim.bip}} models.
#'
#' @param x An \code{EpiModel} object of class \code{\link{netest.bip}}.
#' @param nw A \code{networkDynamic.bip} object.
#' @param nsteps Number of time steps to simulate the network over.
#' @param nsims Number of independent network simulations.
...
#' @keywords netUtils internal
#'
sim_nets.bip <- function(x, nw, nsteps, control) {
...
#'
#' @description This function resimulates the dynamic network in stochastic
#'              network models simulated in \code{\link{netsim.bip}} with dependence
#'              between the epidemic and demographic processes and the network
#'              structure.
#'
#' @param x A master object passed through \code{\link{netsim.bip}}.
#' @param at Current time step.
#'
#' @export
#' @keywords netUtils internal
#'
resim_nets.bip <- function(dat, at) {
...
#'
#' @description Adjusts the edges coefficient in a dynamic network model
#'              simulated in \code{\link{netsim.bip}} to preserve the mean
#'              degree of nodes in the network.
#'
#' @param dat Master object in \code{netsim.bip} simulations.
#' @param at Current time step.
#'
#' @keywords internal
#' @export
#'
edges_correct.bip <- function(dat, at) {
