...
#'
#' @param s.num Number of initial susceptible.
#' @param i.num Number of initial infected.
#' @param r.num Number of initial recovered. This parameter is only used for
...
#' @title Initial Conditions for Deterministic Bipartite Compartmental Models
#'
#' @description Sets the initial conditions for bipartite deterministic compartmental
#'              models simulated with \code{dcm}.
#'
#' @param s.num Number of initial group 1 susceptible.
#' @param i.num Number of initial group 1 infected.
#' @param r.num Number of initial initial group 1 recovered. This parameter is only used for
#'        the \code{SIR} model type.
#' @param s.num.g2 Number of initial susceptible in group 2.
#' @param i.num.g2 Number of initial infected in group 2.
#' @param r.num.g2 Number of initial recovered in group 2. This parameter is
#'        only used for two-group \code{SIR} models.
#' @param ... Additional initial conditions passed to model.
#'
#' @details
#' The initial conditions for a model solved with \code{\link{dcm.bip}} should be
#' input into the \code{init.dcm.bip} function. This function handles initial
#' conditions for both base model types and original models. For an overview
#' of initial conditions for base DCM class models, consult the
#' \href{http://statnet.github.io/tut/BasicDCMs.html}{Basic DCMs} tutorial.
#'
...
#' @export
#'
init.dcm.bip <- function(s.num, i.num, r.num, s.num.g2, i.num.g2, r.num.g2,
                         ...) {
  ...
  ## Output
  class(out.p) <- c("init.dcm.bip", "list")
  return(out.p)
}


#' @title Initial Conditions for Stochastic Bipartite Individual Contact Models
#'
#' @description Sets the initial conditions for stochastic individual contact
#'              models simulated with \code{icm}.
#'
#' @param s.num Number of initial group 1 susceptible.
#' @param i.num Number of initial group 1 infected.
#' @param r.num Number of initial group 1 recovered. This parameter is only used for
#'        the \code{SIR} model type.
#' @param s.num.g2 Number of initial susceptible in group 2.
#' @param i.num.g2 Number of initial infected in group 2.
#' @param r.num.g2 Number of initial recovered in group 2. This parameter is
...
#'
#' @details
#' The initial conditions for a model solved with \code{\link{icm.bip}} should be
#' input into the \code{init.icm.bip} function. This function handles initial
#' conditions for both base models and original models using new modules. For
#' an overview of initial conditions for base ICM class models, consult the
#' \href{http://statnet.github.io/tut/BasicICMs.html}{Basic ICMs} tutorial.
#'
#' @seealso Use \code{\link{param.icm.bip}} to specify model parameters and
#'          \code{\link{control.icm.bip}} to specify the control settings. Run the
...
#' @export
#'
init.icm.bip <- function(s.num, i.num, r.num,
                         s.num.g2, i.num.g2, r.num.g2, ...) {
...
#'              simulated with \code{netsim}.
#'
#' @param i.num Number of initial mode 1 infected.
#' @param r.num Number of initial mode 1 recovered. This parameter is only used for
#'        the \code{SIR} model type.
#' @param i.num.m2 Number of initial infected in mode 2.
...
#'
#' @details
#' The initial conditions for a model solved with \code{\link{netsim.bip}} should be
#' input into the \code{init.net.bip} function. This function handles initial
#' conditions for both base models and new modules. For an overview of
#' specifying initial conditions across a variety of base network models,
#' consult the \href{http://statnet.github.io/tut/BasicNet.html}{Basic Network
#' Models} tutorial.
