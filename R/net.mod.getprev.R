...
#' @title Get Epidemic Output from bipartite netsim Model
#'
#' @description Provides all active model state sizes from the network at the
#'              specified time step, output to a list of vectors.
#'
...
#' @details
#' This network utility is used during the \code{\link{netsim}} simulation
#' process to efficiently query the overall state of the network as well as
#' the current state size for each mode in the model at any given timestep.
#'
#' @export
#' @keywords netUtils internal
#'
