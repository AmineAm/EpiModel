...
#' @title EpiModel Web
#'
#' @description Runs a web browser-based GUI of the birpartite versions of
#' deterministic compartmental models, stochastic individual contact models,
#' and basic network models.
#'
#' @param class Model class, with options of \code{"dcm"}, \code{"icm"}
#'        and \code{"net"}.
#' @param ... Additional arguments passed to \code{shiny::runApp}.
...
#' \dontrun{
#' ## Deterministic compartmental models
#' epiweb(class = "dcm.bip")
#'
#' ## Stochastic individual contact models
#' epiweb(class = "icm.bip")
#'
#' ## Stochastic network models
#' epiweb(class = "net.bip")
#' }
#'
epiweb.bip <- function(class, ...) {
  if (class == "dcm.bip") {
    shiny::runApp(system.file("shiny", "epidcm", package = "EpiModel"), ...)
  } else if (class == "icm.bip") {
    shiny::runApp(system.file("shiny", "epiicm", package = "EpiModel"), ...)
  } else if (class == "net.bip") {
    shiny::runApp(system.file("shiny", "epinet", package = "EpiModel"), ...)
  } else {
    stop("Specify class as either \"dcm.bip\", \"icm.bip\" or \"net.bip\" ", call. = FALSE)
  }
}
