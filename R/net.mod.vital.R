...
#' @title Departures: netsim.bip Module
#'
#' @description This function simulates departure for use in \link{netsim.bip} simulations.
#'
#' @param dat Master list object containing a \code{networkDynamic} object and other
...
#' @title Arrivals: netsim.bip Module
#'
#' @description This function simulates new arrivals into the network
#'   for use in \code{\link{netsim.bip}} simulations.
#'
